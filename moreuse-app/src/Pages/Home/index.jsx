...
const Home = () => {
  //con <Page> yo digo que lo que está dentro de <Page> quiero que se renderice en el componente <Page>. Le digo a Page le voy a mandar algo y ud me lo renderiza
  return (
    <Page>
      <WearListContainer>
        {
          WEAR_LIST.map((item, key) => <WearItem key={key} {...item} />)
          //poner {..item} es lo mismo que poner image=
        }
      </WearListContainer>
    </Page>
  )
